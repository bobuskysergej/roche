...
public class ProductController {
    ...
    @ApiOperation(value = "Retrieves the details of a product", notes = "This endpoint retrieves the details of a product from the database.")
    @GetMapping("{id}")
    public ProductDto get(@PathVariable("id") String productId) {
        return productMapper.toProductDto(service.get(productId));
    }

    @ApiOperation(value = "Retrieves the details of all products", notes = "This endpoint retrieves the details of all products from the database.")
    @GetMapping
